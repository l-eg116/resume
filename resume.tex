...
\section{Éducation}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Ingénieur généraliste, électif Cryptographie}{Sept. 2021 -- Aujourd'hui}
    \resumeSubheading
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Développement d'une application polyvalente open-source citée en projets}
      \resumeItemListEnd
...
\section{Projets}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\href{https://github.com/KodeLab-fr/ExpenseTracker}{\textbf{Application polyvalente}} $|$ \emph{Dart, Python, SQL, FastAPI, Git, Docker}}{Juin 2023 -- Aujourd'hui}
          \resumeItemListStart
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\href{https://github.com/MorganKryze/ConsoleAppVisuals}{\textbf{Librairie : ConsoleAppVisuals}} $|$ \emph{Csharp, Bash, Git, NuGet, GitHub Packages}}{Sept. 2023 -- Nov.2023}
          \resumeItemListStart
            \resumeItem{Création de librairie Csharp facile d'utilisation pour afficher des fonctionnalités graphiques dans la console (sélecteurs, barres de progression, etc.)}
            \resumeItem{Automatisation du déploiement de la documentation à l'aide de GitHub Actions et DocFX }
            \resumeItem{Publication de la librairie sur GitHub Packages et NuGet avec plus de 800 téléchargements}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Compétences Techniques}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Langues}{: Français (langue maternelle), Anglais B2-C1 (TOEFL : 587, TOEIC : 890)} \\
     \textbf{Langages informatiques}{: Csharp, C++, Dart, Python, SQL} \\
     \textbf{Frameworks}{: Flutter (GetX), FastAPI, Arduino} \\
     \textbf{Librairies}{: pandas, NumPy, FastAPI, get, dartz, ConsoleAppVisuals} \\
     \textbf{Outils de développement}{: GitHub, Docker, VS Code, Visual Studio, Bash, Arduino IDE, XCode, UnityHub} \\
     \textbf{Logiciels}{: Notion, Arc, Fusion360, KiCad, Thunderbird, UTM, Suite Office}
    }}
 \end{itemize}
